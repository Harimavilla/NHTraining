...
namespace QuizApplication
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("###########################################");
            Console.WriteLine("Hi {0}.Welcome to the quiz by chandana", name);
            Console.WriteLine("###########################################");
            ...
            StreamWriter sw = new StreamWriter("D:\\NB Trainings\\core.txt", true);
            sw.WriteLine($"Score={score}");
            sw.Close();
            File.WriteAllText("D:\\NB Trainings\\score.txt", $"Score={score}");
            Console.ReadLine();
